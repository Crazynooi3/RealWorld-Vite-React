...
| ----------------------------------- | ----------------------------------------------------------------- | ---------------------------------------------------------------------- |
| ![صفحه اصلی](public/screenshot.png) | ![مقاله](https://via.placeholder.com/300x200.png?text=صفحه+مقاله) | ![پروفایل](https://via.placeholder.com/300x200.png?text=پروفایل+کاربر) |
